...
import com.weeryan17.mixer.server.Config;
import com.weeryan17.mixer.server.models.web.WebHandlerObjects;
import com.weeryan17.mixer.server.utils.GsonJsonMapper;
...
public class WebController {
    ...
    private int initApiController(WebHandlerObjects handlerObjects) {
        ...
        Map<String, List<WebHandler>> webHandlerMap = getWebHandlers("com.weeryan17.mixer.server.web.routes.api", handlerObjects);
    ...
    private int initMixerController(WebHandlerObjects handlerObjects) {
        ...
        Map<String, List<WebHandler>> webHandlerMap = getWebHandlers("com.weeryan17.mixer.server.web.routes.mixer", handlerObjects);
